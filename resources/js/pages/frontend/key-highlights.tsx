...
const highlights = [
    {
        ...
        bullets: ['23.3 km elevated corridor', '23 stations', 'Hinjawadi to Shivajinagar', 'Covers key IT and business hubs', 'Precision-engineered elevated trackway'],
...
const projectHighlights = [
    {
        ...
        description:
            "Strengthening Pune's vital IT corridor by connecting Hinjawadi to Shivajinagar via a 23.3 km fully elevated metro line featuring 23 modern stations.",
    },
    {
