...
import SationTableList from '@/components/station-table-list'
...
export default function NonFareBusinessRevenue() {
    return (
        <>
                    ...
                    <div className="grid gap-5 md:grid-cols-3">
                        ...
                        >
                            ...
                            <ul className="list-disc space-y-1 pl-5">
                                ...
                                <li className="font-montserrat text-sm text-black">
                                    Large Format F&amp;B Concepts
                                </li>
                                <li className="font-montserrat text-sm text-black">
                                    Entertainment &amp; Family Recreation
                                    Centres
                                </li>
                                <li className="font-montserrat text-sm text-black">
                                    Anchor Retail Developments
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            {/* station available for the retail */}
            <section className="bg-white py-10 md:py-6">
                <div className="mx-auto max-w-325.75 px-6 min-[1303px]:px-8 min-[1440px]:max-w-360">
                    <PageSectionHeading
                        ...
                        className="mb-6 flex items-center gap-6 md:mb-8"
                    >
                        Stations Available for Retail
                    </PageSectionHeading>

                   <SationTableList></SationTableList>
                </div>
            </section>
            ...
            <section className="bg-white py-10 md:py-12">
                <div className="mx-auto max-w-325.75 px-6 min-[1303px]:px-8 min-[1440px]:max-w-360">
                    ...
                    <ul className="list-disc space-y-2 pl-5">
                        <li className="font-montserrat text-sm text-black">
                            Access to a large and diverse commuter base
                        </li>
                        <li className="font-montserrat text-sm text-black">
                            High visibility and footfall
                        </li>
                        <li className="font-montserrat text-sm text-black">
                            Flexible retail formats to suit varied business
                            requirements
                        </li>
                        <li className="font-montserrat text-sm text-black">
                            Opportunities for both retail and internal station
                            advertising
                        </li>
                    </ul>
                </div>
