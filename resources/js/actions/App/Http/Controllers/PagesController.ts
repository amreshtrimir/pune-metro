...
const PagesController = { overview, board, projectUpdate, keyHighlights, routeMap, stationList, timeTable, fareTable, dosAndDonts, itemsNotToCarry, offencesAndPenalties, lostAndFound, customerService, lastMileConnectivity, retailFnb, stationAreaMap, passengerAmenities, termsAndConditions, privacyPolicy, eiaReports, carbonCredit, artFromScrap, greenInitiatives }
