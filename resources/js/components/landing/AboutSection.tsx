            ...
            <div className="mx-auto max-w-[1303px] min-[1440px]:max-w-[1440px] px-6 lg:px-16">
                <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
                    ...
                    <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                        <div className="">
                            <img
                                src="/landing/metro-interior-new.png"
                                alt="Metro Interior"
                    ...
                    <div className={`lg:pl-4 transition-all duration-700 delay-200 ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                        ...
                        <p className="mb-8 font-montserrat text-sm leading-relaxed text-black">
                            Pune IT City Metro Rail Limited(PITCMRL), popularly known as Pune Metro Line 3, is a Special Purpose Vehicle (SPV) established through a strategic joint venture between the Tata Group and Siemens. The company is responsible for the design, construction, financing, operation and transfer of the Hinjawadi–Shivajinagar metro corridor. This project is being executed under a 35-year DBFOT (Design–Build–Finance–Operate–Transfer) concession awarded by the Pune Metropolitan Region Development Authority (PMRDA).
                        </p>
