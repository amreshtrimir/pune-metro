...
function SocialIcons() {
    return (
        <>
            <a href="#" className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand text-white transition-opacity hover:opacity-80" aria-label="Facebook">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
            </a>
            <a href="#" className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand text-white transition-opacity hover:opacity-80" aria-label="LinkedIn">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
            </a>
            <a href="#" className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand text-white transition-opacity hover:opacity-80" aria-label="X">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
            </a>
            <a href="#" className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand text-white transition-opacity hover:opacity-80" aria-label="Instagram">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <footer className="border-t border-gray-200 bg-white py-6">
                <div className="mx-auto max-w-360 px-6 lg:px-16">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:gap-0">
                        ...
                        {/* Left column: logo + nav links + divider + copyright */}
                        <div className="flex min-w-0 flex-1 flex-col">
                            ...
                            <div className="flex flex-wrap items-center lg:flex-nowrap">
                                {footerLinks.map((link, i) => (
                                    <span key={link} className="flex items-center">
                                        <a
                                            href="#"
                                            className="whitespace-nowrap font-montserrat text-xs text-gray-600 transition-colors hover:text-brand"
                                        >
                                            {link}
                                        </a>
                            ...
                            {/* Pink divider */}
                            <div className="my-4 h-px w-full bg-brand/30" />
