...
function SocialIcons() {
    return (
        <>
            <a href="https://www.facebook.com/profile.php?id=61574291447959" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center rounded-full bg-brand/15 text-brand transition-colors hover:bg-brand/25" style={{ width: '35px', height: '35px' }} aria-label="Facebook">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
            </a>
            <a href="https://www.linkedin.com/company/puneri-metro-3/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center rounded-full bg-brand/15 text-brand transition-colors hover:bg-brand/25" style={{ width: '35px', height: '35px' }} aria-label="LinkedIn">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
            </a>
            <a href="https://x.com/MetroPuneri" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center rounded-full bg-brand/15 text-brand transition-colors hover:bg-brand/25" style={{ width: '35px', height: '35px' }} aria-label="X">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
            </a>
            <a href="https://www.instagram.com/puneri_metro3/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center rounded-full bg-brand/15 text-brand transition-colors hover:bg-brand/25" style={{ width: '35px', height: '35px' }} aria-label="Instagram">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.youtube.com/@punemetroline3/featured" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center rounded-full bg-brand/15 text-brand transition-colors hover:bg-brand/25" style={{ width: '35px', height: '35px' }} aria-label="YouTube">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="relative min-h-75 w-full">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center px-6 py-10 text-center sm:py-12">
                            <p className="mb-5 max-w-3xl font-montserrat text-sm font-normal leading-relaxed text-white/80 sm:mb-8 lg:text-base">
                                ...
                                travel, Puneri Metro Line 3 is here to transform your journey with comfort, efficiency, and modern connectivity.
                            </p>
                            ...
                            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                                ...
                                >
                                    ...
                                    Mail Us: support@punerimetro.in
                                </a>
                                {/* <a
